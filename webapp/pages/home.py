                    ...
                    html.Figure(
                        [
                            html.Img(
                                ...
                                alt="Time lapse imaging becomes an ordered immune-cell contact history, then Bayesian models compare random variation, stable cell differences, donor structure and changes after previous contacts.",
                                width=1820,
                                height=867,
                            ),
